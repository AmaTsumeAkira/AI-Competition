...
export const cliLevels: TrackLevel[] = [
  {
    ...
    score: 20,
    phase: 'prelim',
    description: '组委会提供标准化部署文档，选手需根据文档完成 2 个指定 CLI 工具的安装与基础配置，并使用这两个工具分别创建一个 HelloWorld 级别的应用项目。',
    criteria: [
      { id: 'C1-01', name: '环境搭建能力', detail: '正确安装CLI工具、配置环境变量（PATH）、验证安装版本' },
      { id: 'C1-02', name: '基础配置能力', detail: '完成工具初始化配置（API Key绑定、默认模型选择、代理设置等）' },
      { id: 'C1-03', name: '项目初始化', detail: '使用CLI工具生成项目脚手架、创建基本文件结构' },
      { id: 'C1-04', name: '基本交互验证', detail: '成功通过CLI工具进行代码生成、代码解释等基本交互操作' },
      { id: 'C1-05', name: '文档阅读能力', detail: '对标准技术文档的理解和执行能力' },
    ],
    standards: [
      'CLI工具正确安装并可正常运行',
      'HelloWorld项目功能完整且可执行',
      '部署报告清晰完整',
    ],
    deliverables: [
      '2个CLI工具的成功安装截图/录屏',
    ...
    hint: 'pip 使用清华镜像：pip install -i https://pypi.tuna.tsinghua.edu.cn/simple/',
  },
  {
    id: 'L2',
