...
export default function Guide() {
  const steps: StepProps[] = [
    ...
    },
    {
      ...
      tip: '推荐使用虚拟环境隔离依赖：python3 -m venv venv && source venv/bin/activate（Windows: python -m venv venv && venv\\Scripts\\activate）',
    },
    {
      number: 4,
      title: '安装依赖',
